                    ...
                    <li class="dropdown dropdown-hover dropdown-user">
                            ...
                            <div class="dropdown-menu">
                                <form class="navbar-login-form" action="{{ route('login') }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-sm ml-0 mr-0" name="submit">Log In</button>
                                    <br>
                                    <p>
                                        <a href="{{ route('password.request') }}" class="no-fade" >Lost password?</a> | <a href="{{ route('register') }}" class="no-fade">Register</a>
                                    </p>
                                </form>
                            </div>
                    </li>
